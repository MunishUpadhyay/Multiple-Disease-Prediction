...
st.set_page_config(page_title='Multiple Disease Prediction System', layout='centered', page_icon='hospital', initial_sidebar_state='auto')
...
if(selected == 'Parkinsons Prediction'):
    ...
    if st.button('Parkinsons Test Result'):
        ...
        DDP, Shimmer, Shimmer_dB, APQ3, APQ5, APQ, DDA, NHR, HNR, RPDE,
        DFA, spread1, spread2, D2, PPE]])

        if (parkinsons_prediction[0] == 1):
            parkinsons_prediction = "The person has Parkinson's disease"
        else:
            parkinsons_prediction = "The person does not have Parkinson's disease"
